...
| LLM Work Mirror (L*) | S0–S5: ChatGPT/export llm-ops (events → episodes → 6-axis scores → operator profile); coding sources stay in coding-ops only — [docs/llm-work-mirror-roadmap.md](docs/llm-work-mirror-roadmap.md) |
...
apps/data-verse          Ikeda-style viz frontend, rollback copy — docs/data-verse.md
                         (primary frontend: jackye426/data-verse-render → jackye.wiki)
