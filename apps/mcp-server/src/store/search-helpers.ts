...
export const EMPTY_MEMORY_HINT =
  "No memory hits. Ensure session distillates exist (POST /v1/distillate or pnpm distillate). Semantic search needs OPENAI_API_KEY + distillates.embedding; keyword path still searches distillate content and canonical payload text.";
