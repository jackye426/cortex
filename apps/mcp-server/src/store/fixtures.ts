...
export const FIXTURE_RECORDS: RecordHit[] = [
  ...
  },
  {
    ...
    contentHash: "hash-ebook-1",
    occurredAt: "2026-07-10T12:00:00.000Z",
  },
  {
    id: "e1e1e1e1-e1e1-4e1e-8e1e-e1e1e1e1e1e1",
    sourceId: "calibre",
    sourceRecordId: "ebook-taste-1",
    recordType: "ebook",
    payload: {
...
export let fixtureDistillates: DistillateRow[] = [
  ...
  },
  {
    ...
    subjectType: "week",
    subjectId: "a0280000-0000-4000-8000-000000002029",
    kind: "browser_interest_digest",
    content:
      "Browser week 2026-W28: recurring architecture and gallery research; bookmarks on museum exhibitions.",
    embeddingRef: "fixture:hash",
    embedding: fixtureEmbedFromText(
      "browser architecture gallery museum research bookmarks",
    ),
    ...
    metadata: {
      ...
      domain: "interest",
      sourceType: "browser",
      topics: ["architecture", "gallery", "agent-memory"],
      recurring: ["architecture", "gallery"],
      themes: ["architecture", "galleries"],
      confidence: 0.7,
      compilerVersion: "browser-interest-v2",
      weekKey: "2026-W28",
    },
  ...
  },
  {
    ...
    subjectType: "week",
    subjectId: "a0280000-0000-4000-8000-000000002030",
    kind: "reading_interest_digest",
    content:
      "Reading week 2026-W28: architecture criticism and taste development titles.",
    embeddingRef: "fixture:hash",
    embedding: fixtureEmbedFromText(
      "reading architecture criticism taste development books",
    ),
    model: "fixture-reading",
    metadata: {
      fixture: true,
      domains: ["interest", "reference"],
      domain: "interest",
      sourceType: "calibre",
      topics: ["architecture", "taste"],
      recurring: ["architecture"],
      themes: ["architecture criticism"],
      confidence: 0.68,
      compilerVersion: "reading-interest-v1",
      weekKey: "2026-W28",
    },
